                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="smk-side">Universitas Mulawarman</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side"> Jl. Kuaro, Gn. Kelua, Kec. Samarinda Ulu, Kabupaten Paser, Kalimantan Timur 75119</p>';
                            }
                        }
                    ?>
                </div>
